...
Чтобы получить доступ к документации по автоматическому API, просто перейдите в раздел http://127.0.0.1:5000/docs в веб-браузере. На этой странице будет отображаться интерактивная документация, созданная FastAPI, позволяющая увидеть доступные эндпоинты и их параметры.
